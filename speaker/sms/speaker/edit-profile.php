...
$sql=mysqli_query($con,"Update speaker set specilization='$spespecialization',speakerName='$spename',address='$speaddress',speFees='$spefees',contactno='$specontactno' where id='".$_SESSION['id']."'");
if($sql)
{
echo "<script>alert('Speaker Details updated Successfully');</script>";
...
<html lang="en">
	<head>
		<title>Speaker | Edit Speaker Details</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Speaker | Edit Speaker Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Speaker</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Speaker</h5>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from speaker where speEmail='".$_SESSION['dlogin']."'");
