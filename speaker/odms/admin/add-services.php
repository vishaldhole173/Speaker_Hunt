...
$sql="insert into tblservice(ServiceName,SerDes,ServicePrice,link)values(:sername,:serdes,:serprice,:link)";
...
<!doctype html>
 <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
 <title>Onlind Webinar Management System - Add Services</title>
                            ...
                            <div class="block block-themed">
                                ...
                                <div class="block-content">
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-12" for="register1-password">Service Organiser:</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="serprice" value="" required='true'>
                                            </div>
                                        </div>
                                         <div class="form-group row">
                                            <label class="col-12" for="register1-password">Service Registration link:</label>
                                            <div class="col-12">
                                                <input type="text" class="form-control" name="link" value="" required='true'>
                                            </div>
                                        </div>
