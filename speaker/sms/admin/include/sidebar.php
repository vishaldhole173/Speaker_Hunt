...
<nav>
						...
						<ul class="main-navigation-menu">
							...
							<li>
								...
								<ul class="sub-menu">
									<li>
										<a href="speaker-specilization.php">
											<span class="title"> Speaker Specialization </span>
										</a>
									</li>
									<li>
									...
									<li>
										<a href="Manage-speaker.php">
											<span class="title"> Manage Speaker </span>
										</a>
									</li>
...
<li>
	...
	<li>
								<a href="speaker-logs.php">
									<div class="item-content">
										<div class="item-media">
											<i class="ti-list"></i>
										</div>
										<div class="item-inner">
											<span class="title"> Speaker Session Logs </span>
										</div>
									</div>
								</a>
							</li>		
