<div class="header">
     <div class="container">
         <div class="logo">
             <a href="index.php"><h1 style="color: white; font-family: sans-serif;font-size: 40px;">Webinar Registration</h1></a>
         </div>
         <div class="top-menu">
             <ul>
             ...
             <li><a href="../index.html"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Speaker Manegement System</a></li>
             </ul>
         </div>
