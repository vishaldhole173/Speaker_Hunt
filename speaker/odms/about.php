...
<html>
<head>
<title>Online Webinar Management System || About Us</title>
...
{               ?>
		 ...
		 <div class="about-main">
			 <div class="col-md-6 abt-pic">
				 <img src="images/431427.jpg" class="img-responsive" alt=""/>
			 </div>
		 ...
		 <!-- <div class="latest">
			 <h3>LATEST PHOTOS</h3>		
			 <div class="pic start">
				 <a class="fancybox" href="images/slider-image1.jpg" data-fancybox-group="gallery" title="Lorem ipsum dolor sit amet"><img src="images/slider-image1.jpg" class="img-style row6" alt=""><span> </span></a>	
			 ...
			 <div class="pic">
				 ...
				 <h4><a href="event.html">Aenean rutrum</a></h4>
				 <p>Suspendisse posuere enim eu ante sce lerisque, vehicula turpis.</p>
			 </div>
			 <div class="clearfix"></div>
		 </div> -->
