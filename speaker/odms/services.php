...
<html>
<head>
<title>Online Webinar Management System || Webinar Services</title>
			 ...
			 <div class="event-grids">
					...
					<div class="col-md-3 event-grid text-button">
						<ul>
							...
							<li class="button yellow" style="color: white;"><a href="<?php  echo htmlentities($row->link);?>"><?php  echo htmlentities($row->link);?></a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
			  </div>
