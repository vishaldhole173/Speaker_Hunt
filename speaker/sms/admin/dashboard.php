								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Manage Speakers</h2>
										
											<p class="cl-effect-1">
												<a href="manage-speaker.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM speaker ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total Speakers :<?php echo htmlentities($num_rows1);  } ?>		
												</a>
...
<?php $result = mysqli_query($con,"SELECT * FROM tblclient ");
$num_rows = mysqli_num_rows($result);
{
?>
